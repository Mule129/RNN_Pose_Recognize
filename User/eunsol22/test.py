...
class PoseCollet():#함수 종료시 자원회수 되는지 확인하기
    ...
    def save_pose2(self,key_value):
        self.vital_pose={"select pose":0,"front":102,"right":114,"left":108,"jump":106,"back":98}.get(key_value,"알 수 없는")
    ...
    def cap_pose(self):
        ...
        while True:
            ...
            if vital_swich == 0 and (key_value == 114 or 102 or 108 or 106 or 98):
                self.save_pose2(key_value)
                #key_value={"0":"select pose","102":"front","114":"right","108":"left","106":"jump","98":"back"}
